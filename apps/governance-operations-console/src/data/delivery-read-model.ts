...
export const deliveryReadModel: DeliveryReadModel = {
  ...
  packages: [
    ...
    },
    {
      ...
      summary: "Execution has started and remaining child fronts are still open.",
      target_pi: "PI-2026-03",
      tone: "ok",
    ...
    roots: [
      {
        ...
        description: "Delivery package shell with ready child fronts and one milestone checkpoint.",
        backend_status: "ready",
